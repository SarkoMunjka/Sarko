...
export const CASE_STUDIES_SR: CaseStudyContent[] = [
  ...
  },
  {
    ...
    intro:
      'Kurirani boravci za odmor i ponovno povezivanje — vile, kuće, apartmani i vikendice. Izgradili smo hospitality demo sa Moonstay pill navigacijom i istim cinematic animation stackom kao kod berbera.',
    liveUrl: '/work-demos/moonstay/',
    meta: [
      { label: 'Uloga', value: 'Identitet · Web · Razvoj' },
      { label: 'Vremenski okvir', value: '2026 · 5 nedelja' },
      { label: 'Usluge', value: 'Strategija, Dizajn, Razvoj' },
      { label: 'Platforma', value: 'Prilagođen statički sajt' },
    ],
    overview: {
      heading: 'Tišina kao\nluksuz.',
      paragraphs: [
        'Moonstay kurira vile, kuće i povlačenja za ljude koji žele da uspore — ali većina rental sajtova deluje generički i pretrpano. Iskustvo je moralo da prenese mir, prostor i pažljiv odabir od prvog kadra.',
        'Demo koristi isti animation stack kao Lukić Barber: scroll-scrub hero, marquee, blur-to-focus reveal i progress bar — uz system-ui tipografiju i Moonstay pill UI.',
      ],
    },
    challenge: {
      heading: 'Rental brend učiniti\nnedvosmisleno kuriranim.',
      body: 'Takmičenje samo brojem oglasa nije bila opcija — Moonstay pobeđuje atmosferom, selekcijom i osećajem bekstva. Sajt je morao da proda tišinu za nekoliko sekundi i učini pregled boravaka jednako primamljivim kao dolazak.',
    },
    approach: [
      {
        no: '01',
        title: 'Mir kao proizvod',
        body: 'Minimalistički vizuelni jezik, prirodne fotografije i tipografija koja diše — Moonstay kao kurator autentičnih boravaka, ne još jedan booking portal.',
      },
      {
        no: '02',
        title: 'Scroll-scrub hero',
        body: 'Pinovan hero koji kroz skrol otkriva planinsku vilu kadar po kadar — isti cinematic pristup kao kod berber demo sajtova, prilagođen hospitality segmentu.',
      },
      {
        no: '03',
        title: 'Pill navigacija',
        body: 'Centrirana staklena navigacija i CTA „Započni pobeg“ — UI inspirisan high-end rental referencama, sa našim proverenim animation patternima.',
      },
      {
        no: '04',
        title: 'Boravci koji prodaju atmosferu',
        body: 'Grid nekretnina, kartice lokacija i dual marquee utisci sa blur-to-focus reveal animacijama — svaki detalj vodi ka osećaju tišine pre rezervacije.',
      },
    ],
    gallery: [
      {
        src: '/work-demos/moonstay/hero-poster.jpg',
        label: 'Početna · scroll hero',
        alt: 'Moonstay hero početne stranice',
      },
      {
        src: '/work-demos/moonstay/img/stay-01.jpg',
        label: 'Grid boravaka',
        alt: 'Moonstay kartice nekretnina',
      },
      {
        src: '/work-demos/moonstay/img/mood.jpg',
        label: 'Atmosfera',
        alt: 'Moonstay mood sekcija',
      },
    ],
    gallerySiteUrl: 'moonstay.rs',
    palette: [
    ...
    paletteHeading: 'Prirodni minimalni luksuz',
    results: {
      sectionLabel: 'Rezultati',
      heading: 'Rani signali sa\nlansiranja demoa.',
      items: [
        { value: '2.8×', label: 'Vreme na sajtu' },
        { value: '+41%', label: 'Klikovi na upit' },
        { value: '-32%', label: 'Stopa odlazaka' },
        { value: '4.8/5', label: 'Ocena klijenta' },
      ],
      quote: {
        text: 'Scroll hero deluje kao otvaranje vrata vile — gosti se već zamišljaju tamo pre nego što rezervišu.',
        attribution: 'Osnivač, Moonstay',
      },
    },
    coverImage: '/work-demos/moonstay/hero-poster.jpg',
    ctaHeading: 'Gradite hospitality brend?',
    ctaSubtext: 'Hajde da osmislimo mirno, kinematsko iskustvo koje vaši boravci zaslužuju.',
  },
  {
    slug: 'novaframe',
    name: 'NovaFrame',
