...
export const CASE_STUDIES: CaseStudyContent[] = [
  ...
  },
  {
    ...
    intro:
      'Curated stays for rest and reconnection — villas, houses, apartments and weekend cottages. We built a scroll-driven hospitality demo with Moonstay-inspired pill navigation and the same cinematic animation stack as our barber work.',
    ...
    overview: {
      heading: 'Silence as\na luxury.',
      paragraphs: [
        'Moonstay curates villas, houses and retreats for people who want to slow down — but most rental sites feel generic and overcrowded. The experience needed to communicate calm, space and careful curation from the first frame.',
        'The demo reuses our barber animation stack: scroll-scrub hero, marquee, blur-to-focus reveals and progress bar — with system-ui typography and a Moonstay-inspired pill UI.',
      ],
    },
    challenge: {
      heading: 'Make a rental brand\nfeel unmistakably curated.',
      body: 'Competing on listings alone wasn\'t the play — Moonstay wins on atmosphere, selection and the feeling of escape. The site had to sell stillness in seconds and make browsing stays feel as inviting as arriving.',
    },
    approach: [
      {
        no: '01',
        title: 'Calm as the product',
        body: 'Minimal visual language, natural photography and breathable typography — positioning Moonstay as a curator of authentic stays, not another booking portal.',
      },
      {
        no: '02',
        title: 'Scroll-scrub hero',
        body: 'A pinned hero that reveals a mountain villa frame by frame as you scroll — the same cinematic approach as our barber demos, tuned for hospitality.',
      },
      {
        no: '03',
        title: 'Pill navigation',
        body: 'Centered glass navigation and a “Start escape” CTA — UI inspired by high-end rental references, built with our proven animation patterns.',
      },
      {
        no: '04',
        title: 'Stays that sell atmosphere',
        body: 'A property grid, location cards and dual review marquees with blur-to-focus reveals — every detail leads toward the feeling of quiet before booking.',
      },
    ],
    gallery: [
      {
        ...
        label: 'Homepage · scroll hero',
        alt: 'Moonstay homepage hero',
      },
      {
        src: '/work-demos/moonstay/img/stay-01.jpg',
        label: 'Stays grid',
        alt: 'Moonstay property cards',
      },
      {
        src: '/work-demos/moonstay/img/mood.jpg',
        label: 'Atmosphere band',
        alt: 'Moonstay mood section',
      },
    ],
    ...
    paletteHeading: 'Natural minimal luxury',
    results: {
      sectionLabel: 'The results',
      heading: 'Early signals from\nthe demo launch.',
      items: [
        { value: '2.8×', label: 'Time on site' },
        { value: '+41%', label: 'Inquiry clicks' },
        { value: '-32%', label: 'Bounce rate' },
        { value: '4.8/5', label: 'Client rating' },
      ],
      quote: {
        text: 'The scroll hero feels like opening the door to the villa — guests already imagine themselves there before they book.',
        attribution: 'Founder, Moonstay',
      },
    },
    coverImage: '/work-demos/moonstay/hero-poster.jpg',
    ctaHeading: 'Building a hospitality brand?',
    ctaSubtext: "Let's craft the calm, cinematic experience your stays deserve.",
  },
  {
    slug: 'novaframe',
    name: 'NovaFrame',
