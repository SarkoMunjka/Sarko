  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[1440px] px-5 sm:px-8 lg:px-12">
        <div className="rounded-3xl border border-black/10 bg-[#F26522] px-6 py-14 shadow-[0_20px_60px_rgba(242,101,34,0.28)] sm:px-10 sm:py-20 lg:px-16 lg:py-24">
          <FadeIn
            as="p"
            y={10}
            className="mb-5 text-[12px] font-medium uppercase tracking-[0.14em] text-black sm:mb-7 sm:text-[13px]"
          >
          ...
          <FadeIn
            as="p"
            className="mt-6 max-w-xl text-[15px] leading-[1.65] text-black sm:text-[17px]"
          >
          ...
          <div className="mt-8 flex flex-col gap-4 sm:mt-10 sm:flex-row sm:items-center sm:gap-5">
            ...
            <a
              ...
              className="text-[14px] font-medium text-black/75 underline decoration-black/20 underline-offset-[5px] transition-colors duration-300 hover:text-black hover:decoration-black/50"
            >
              hello@mark.studio
            </a>
          </div>

          <div className="mt-12 grid grid-cols-2 gap-8 border-t border-black/15 pt-10 sm:mt-16 lg:grid-cols-4">
            {STATS.map((stat, index) => (
              <FadeIn key={stat.label} delay={index * 0.08}>
                <div className="text-[28px] font-medium tracking-tight text-[#1a1a1a] sm:text-[36px]">
                  {stat.value}
                </div>
                <div className="mt-1 text-[13px] text-black/65 sm:text-[14px]">
                  {stat.label}
                </div>
              </FadeIn>
            ))}
